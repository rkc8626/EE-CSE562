...
class startUI(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.connect(self.allui.pbPlayHuman, QtCore.SIGNAL("clicked()"), self.playHuman)
        self.connect(self.allui.pbSelectFile, QtCore.SIGNAL("clicked()"), self.selectFile)
        # self.connect(self.allui.pbCreate, QtCore.SIGNAL("clicked()"), self.createHost)
        self.connect(self.allui.pbCancel, QtCore.SIGNAL("clicked()"), self.cancelCreate)
        # self.connect(self.allui.pbGo, QtCore.SIGNAL("clicked()"), self.playInternet)
        self.tH = threading.Thread(target=self.updateHostList)
        self.tH.setDaemon(True)
        self.tH.start()
        self.tC = threading.Thread()
        self.tM = threading.Thread()
        self.connect(self.allui.pbA1, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbA2, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbA3, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbA4, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbA5, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbA6, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbB1, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbB2, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbB3, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbB4, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbB5, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.connect(self.allui.pbB6, QtCore.SIGNAL("clicked()"), self.PBclicked)
        self.updateControl()
